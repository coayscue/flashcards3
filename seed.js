var cards = [{
    ...
    answers: [{
        text: 'A MongoDB table',
        correct: false
    }, {
        text: 'A way to execute a query with Mongoose',
        correct: false
    }, {
        text: 'A description of a document in MongoDB',
        correct: true
    }],
    category: 'MongoDB'
}, {
    ...
    answers: [{
        ...
        text: 'a tool for accessing a MongoDB database',
        correct: false
    }, {
